...
def main():
    p = argparse.ArgumentParser(prog="oscifgen", description="Oscilloscope & Function Generator (Python)")
    sub = p.add_subparsers(dest="cmd", required=True)

    a = sub.add_parser("acquire", help="Read N bytes at Fs from input and write to output file")
    ...
    g = sub.add_parser("generate", help="Generate N waveform bytes at Fo and write to output file")
